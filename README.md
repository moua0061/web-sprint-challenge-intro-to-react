...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
    React JS is a javascript library built by Facebook team for building user interfaces - components. It is reusuable and can help put together an application with many data and display it to the user. 
1. Describe component state.
    State is basically the data or value that is put in as an object to show the component's current 'situation' or 'state'.
1. Describe props.
    Props is short for properties and is used for passing data from one componenets to another. It is only passed from parent to children and downward. 
